...
--augment applies photometric-only data augmentation on the training images
(never on val — keypoint geometry is untouched, detection runs after
augmentation, so correspondences stay valid), off by default.
"""
