...
# ── config ────────────────────────────────────────────────────────────────────
DATA_ROOT = Path(
    "/shared/sets/datasets/confidential/lynx/processed_frames/segmented/dfk-June-2026-merged/lynx/"
)
INDEX_PATH = Path(__file__).parent.parent / "contrastive_indices" / "train_qk_pairs_filtered.json"
...
OUT_POS = Path(__file__).parent / "positive_pairs_assigned"
OUT_NEG = Path(__file__).parent / "negative_pairs_assigned"
