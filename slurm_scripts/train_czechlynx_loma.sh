...
output_dir=${CZECHLYNX_LOMA_OUTPUT:-/shared/sets/datasets/vision/czechlynx/checkpoints/${CZECHLYNX_RESOLVED_EXPERIMENT}/loma-b-finetuned-${CZECHLYNX_RESOLVED_OUTPUT_SUFFIX}}
run_name=${CZECHLYNX_LOMA_RUN_NAME:-czechlynx-${CZECHLYNX_RESOLVED_EXPERIMENT}-loma-${CZECHLYNX_RESOLVED_PROTOCOL}}
...
accelerate launch --num_processes 4 --num_machines 1 \
  ...
  --output_dir "${output_dir}" --project "${CZECHLYNX_LOMA_PROJECT:-lynx-${CZECHLYNX_RESOLVED_EXPERIMENT}-loma}" \
